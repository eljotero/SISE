...
def main():
    ...
    plt.ylim((0.5, 121))
    plt.xticks(np.arange(1, 8, step=1.0), minor=False)
    plt.yticks(np.arange(0, 121, step=20.0), minor=False)
    plt.yticks(np.arange(0, 121, step=4.0), minor=True)
    plt.title("A*")
    plt.legend(loc="upper left")
    ...
    plt.ylim((0.5, 40))
    plt.xticks(np.arange(1, 8, step=1.0), minor=False)
    plt.yticks(np.arange(0, 41, step=5.0), minor=False)
    plt.yticks(np.arange(0, 41, step=1.0), minor=True)
    plt.title("A*")
    plt.legend(loc="upper left")
    ...
    plt.ylim((0.5, 11.0))
    plt.xticks(np.arange(1, 8, step=1.0), minor=False)
    plt.yticks(np.arange(0, 11.1, step=2.0), minor=False)
    plt.yticks(np.arange(0, 11.1, step=0.5), minor=True)
    plt.title("BFS")
    plt.ylabel("Czas trwania procesu obliczeniowego")
    plt.xlabel("Głębokość")
    plt.legend(loc="upper left", ncol=2)
